<html>
<head>
	<title>KVK-BOOK ENDGAME</title>
	<center>
	<a href="mainpage.php"><img src="kvkposter.jpg" width="850" height="350" title="HOME-KVK" alt="HOME-KVK"></a><br><br><br><br></center>
	<a href='del.php'><img src='cancel2.jpg' width='100' height='40' title='CANCEL BOOKINGS' alt='CANCEL BOOKINGS' align='left'></a>
...
<body background="back2.jpg" text = "#00FF00">
	...
	session_start();
		...
		?>
	<center>
		<h1><marquee width = "50%">WATCH "ENDGAME" TONIGHT @ 9:30PM-KVK THEATERS</marquee><br></h1>
		
		<img src="endgame1.jpg" width="850" height="250" title="ENDGAME" alt="ENDGAME"><br>
        ...
        <form method = "POST" action = "movie1_backend.php">
